...
\- \*\*Separación respuestas / modelo\*\*: las respuestas de la API se deserializan en DTOs (`...Response`) con `@SerialName` para los campos `snake\_case`, y se combinan en un modelo de dominio limpio (`StarWarsCharacter`) que consume la UI.
